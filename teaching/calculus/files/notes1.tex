...
\end{example}
In such a case where we can define a new function $g$ by assigning a value to $f$ at the point of discontinuity, we say that $f$ has a \textit{removable discontinuity} at that point.
